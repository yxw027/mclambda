...
//
//  DESCRIPTION:
//  Calls the terminate function LAMBDA_terminate, which is named for the 
//  alphabetically first entry-point function foo declared for code generation. 
//  Call the terminate function only once, even if you have multiple entry-point 
//  functions called in the function main. 
//  
// --------------------------------------------------------------------------  
