  ...
  object Misc: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object MCoptions: TComboBox
        ...
        Style = csDropDownList
        TabOrder = 21
        TextHint = '1. ILS search-and-shrink ("ncands" = 10)'
        OnChange = MCchange
        Items.Strings = (
          '1. ILS search-and-shrink ("ncands" = 10)'
          '2. ILS enum in search ("ncands" = 10)'
          '3: Integer rounding method'
          '4: Integer bootstrapping method'
          '5: ILS Ratio Test ("PO" = 0.01)'
          '6: ILS Ratio Test ("MU" = 0.5)')
      end
    end
