...
//	MapFunc	     ->ItemIndex	=MainForm->MapFunc;
	...
	MCoptions	 ->ItemIndex	=MainForm->MCoptions;
...
//	MainForm->MapFunc		=MapFunc	->ItemIndex;
	...
	MainForm->MCoptions	  	=MCoptions  ->ItemIndex;
...
//	MapFunc	     ->ItemIndex	=prcopt.mapfunc;
	...
	MCoptions	 ->ItemIndex	=prcopt.mcopt;
...
//	prcopt.mapfunc	=MapFunc	->ItemIndex;
	...
	prcopt.mcopt	=MCoptions  ->ItemIndex;
...
void __fastcall TOptDialog::UpdateEnable(void)
{
	...
	AmbRes         ->Enabled=ar;
	MCoptions      ->Enabled=ar&&AmbRes->ItemIndex==5;
...
//---------------------------------------------------------------------------
void __fastcall TOptDialog::MCChange(TObject *Sender)
{
	UpdateEnable();
}
